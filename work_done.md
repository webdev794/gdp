...
| **Help** | Start a support chat (optionally linked to an order), message the store, and attach a photo to a message (e.g. to show a damaged item). Once the store has replied, rate the conversation 1–5 stars with an optional comment at the end of the chat. |
